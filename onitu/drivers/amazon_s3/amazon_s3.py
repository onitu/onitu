...
#    global multipart_upload
    ...
    if bucket:
        ...
        # # metadata.revision currently is a string holding two informations: timestamp of the file's last revision and multipart upload ID, separated by a '\t'.
        # # Here, as we start a multipart upload we update the id. Useful to resume the upload in case of a crash.
        # try:
    ...
    def check_bucket(self):
        ...
        if bucket:
            ...
            for key in keys:
                ...
                except (ValueError, TypeError): # float cast failed or metadata.revision is None, possibly because that's a new file
                    onitu_revision = 0.0
