...
<section>
    ...
    <article>
        ...
        You can now <strong>close this browser window</strong>,
 and return to the application.</p>

        <p class='note'>Powered by
            <a href='http://stuvel.eu/flickrapi'>Python FlickrAPI</a>,
 by Sybren A. Stüvel.</p>
    </article>
</section>
</body>
